                                ...
                                <td className="py-3 px-5 border-b border-blue-gray-50">
                                    <div className="gap-4 w-10/12">
                                        ...
                                        <div className="flex flex-start bg-blue-gray-50 overflow-hidden w-full rounded-sm font-sans text-xs font-medium h-1 mt-1">
                                            <div className={`flex justify-center items-center h-full bg-gradient-to-tr ${project.progress < 100 ?' from-pink-600 to-pink-200' : 'from-green-600 to-green-200'} text-white w-[${project.progress}%]`}></div>
                                        </div>
                                    </div>
                                </td>
                                <td className="py-3 px-5 border-b border-blue-gray-50">
