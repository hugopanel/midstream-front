...
import imageBg from "../../app/assets/image1.png";
...
const Whiteboard: React.FC = () => {
  ...
  const undo = () => connection?.invoke("UndoLastDrawing", whiteboardId);

  const redo = () => connection?.invoke("RedoLastUndoneDrawing", whiteboardId);
